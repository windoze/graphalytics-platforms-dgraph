 ...
 */
package science.atlarge.graphalytics.dgraph.algorithms.bfs;
...
/**
 * Breadth-first Search job implementation for Dgraph. This class is responsible for formatting BFS-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author windoze
 */
public final class BreadthFirstSearchJob extends DgraphJob {
	 ...
	 */
	public BreadthFirstSearchJob(BenchmarkRun benchmarkRun, DgraphConfiguration platformConfig,

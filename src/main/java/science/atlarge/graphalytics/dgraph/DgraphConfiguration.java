 ...
 * @author windoze
 */
public final class DgraphConfiguration {

	protected static final Logger LOG = LogManager.getLogger();

	private static final String BENCHMARK_PROPERTIES_FILE = "benchmark.properties";
	private static final String HOME_PATH_KEY = "platform.dgraph.home";
	private static final String NUM_MACHINES_KEY = "platform.dgraph.num-machines";
	private static final String NUM_THREADS_KEY = "platform.dgraph.num-threads";
	...
	/**
	 * Creates a new DgraphConfiguration object to capture all platform parameters that are not specific to any algorithm.
	 */
	public DgraphConfiguration(){
	}
	...
	public static DgraphConfiguration parsePropertiesFile() {

		DgraphConfiguration platformConfig = new DgraphConfiguration();
